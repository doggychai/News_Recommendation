...
if __name__ == '__main__':
    df_train_click = pd.read_csv('/ExtHDD/Users/hhfile/tianchi/data_raw/train_click_log.csv')
    df_test_click = pd.read_csv('/ExtHDD/Users/hhfile/tianchi/data_raw/testA_click_log.csv')
